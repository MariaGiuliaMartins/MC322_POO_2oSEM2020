...
public class Sala {
	...
	public Sala() {
		...
		id ++; //a cada nova sala criada, incrementa-se o id da sala
		numeroUsuarios ++; //quando se cria uma sala, pelo menos 1 usuário já existe
	}
		
	//metodo construtor com parametros
	public Sala(int capacidadeMaxima, String descricao, Usuario dono, boolean ingressoAutomatico, GregorianCalendar dataCriacao) {
		numeroSalas ++;
		id ++;
		numeroUsuarios ++; 
	...
	///perguntar a capacidade maxima pro teclado - HEEEEEEEELP
	...
	public String toString() {
		...
		out = out + "Salas criadas até agora (não necessariamente pertencem a esse usuário): " + numeroSalas();
		return out;
	}
