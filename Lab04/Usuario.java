...
public class Usuario {
	...
	public void criarGrupo(String nome_grupo, String descricao_grupo, boolean status_grupo) {
		if (this instanceof Admin) { //se for um admin podemos então criar os grupos
			...
			System.out.println("Usuário " + this.getLogin() + "não á adinistrador, então não pode criar grupo.");
		}
	}
	...
	public void removerGrupo(Grupo grupo_remover) {//remove o grupo passado como parametro do array list de grupos que o usuario faz parte
		if (this instanceof Admin) { //se for um admin podemos então criar os grupos
			...
			System.out.println("Usuário " + this.getLogin() + "não é adimnistrador, então não pode remover grupo.");
		}
